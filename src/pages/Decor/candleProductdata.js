...
import image81 from "../../assets/Lifestyle/WoodenLantern/wl1.jpg"
import image82 from "../../assets/Lifestyle/WoodenLantern/wl2.jpg"

import image1 from "../../assets/Front/classicalstarburst.png";
import image2 from "../../assets/Front/starburst.png";
import image3 from "../../assets/Front/solarcandle.png";
import image4 from "../../assets/Front/solarhurricane.jpg";
import image5 from "../../assets/Front/acaciacandle.jpg";
import image6 from "../../assets/Front/eris.png";
import image7 from "../../assets/Front/psyche.png";
import image8 from "../../assets/Front/woodenLantern.jpg"

// Product images
export const productImages = {
  "classical-starburst-lanterns": [image1, image12, image11, image13, image14, image15],
  "starburst-lanterns": [image2, image24, image22, image23, image21, image25],
  "solar-candle-holders": [image3, image31, image32, image33, image34],
  "solar-candle-hurricanes": [image4, image41, image42, image43, image44],
  "acacia-wood-candle-holders": [image5, image51, image52, image53, image54, image55],
  "eris-marble-candle-holders": [image6, image61, image62, image63, image64, image65],
  "psyche-candle-holders": [image7, image71, image72, image73, image74, image75],
  "qdore-wooden-lanterns": [image8,image81, image82]
};
...
export const products = [
  ...
  },
  {
    ...
    price: 5000, // Changed to number
    imageUrl: "QmVrRBQhHxq6m2jFFEd1bo3iFmt4kbnwHqQSVAxGSBXriB",
    material: "Aluminium",
    dimensions: "6.25x6.25x20 Inch"
  },

  {
    ...
    price: 4500, // Changed to number
    imageUrl: "QmVuuPg5MaHwsd42rHx5NzdCptPwEZYofWebC4Nrti9Zar",
    material: "Aluminium, Iron and Glass",
    dimensions: "5.25x5.25x16 Inch"
  },
  {
  ...
  },
  {
    ...
    material: "Aluminium",
    dimensions: "4x4x13.20 Inch"
  },
  {
    id: "qdore-wooden-lanterns",
    name: "QDORE WOODEN LANTERNS",
    description: [
      "Add a warm, elegant glow to your home with 𝐐𝐝𝐨𝐫𝐞 𝐖𝐨𝐨𝐝𝐞𝐧 𝐋𝐚𝐧𝐭𝐞𝐫𝐧𝐬",
      "Natural wood structure meets chrome-plated metal for timeless beauty",
      "Stunning details and a sophisticated design",
      "The perfect lighting décor to brighten any corner of your space.",
    ],
    price: 3200, // Changed to number
    imageUrl: "QmbLUyR1qcqNq3kBMHdtPcqN1agYYCWdama9SJHRmJZimY",
    material: "Acacia Wood",
